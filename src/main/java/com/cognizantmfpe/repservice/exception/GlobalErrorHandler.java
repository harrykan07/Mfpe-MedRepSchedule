...
import com.cognizantmfpe.repservice.model.ErrorResponse;
...
public class GlobalErrorHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleMethodArgTypeMismatchException(MethodArgumentTypeMismatchException e) {
		...
		errorResponse.setMessage("Please enter the date in dd-MMM-yyyy format");
		errorResponse.setReason("You need to provide date in dd-MMM-yyyy format--Eg. 12-Jul-2009");
		errorResponse.setStatus(HttpStatus.BAD_REQUEST);
		errorResponse.setTimestamp(LocalDateTime.now());
